...
class SignupsControllerTest < ActionController::TestCase
  ...
  test "should create signup" do
    assert_difference('Signup.count') do
      post :create, signup: { email: @signup.email, first_name: @signup.first_name, last_name: @signup.last_name }
    end
  ...
  test "should update signup" do
    patch :update, id: @signup, signup: { email: @signup.email, first_name: @signup.first_name, last_name: @signup.last_name }
    assert_redirected_to signup_path(assigns(:signup))
  end
